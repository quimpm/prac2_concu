...
public class InvertedIndexSeq
{
    ...
    // Constructores
    public InvertedIndexSeq() {
        InputFilePath = null;
        KeySize = DKeySize;
    }

    public InvertedIndexSeq(String inputFile) {
        this();
        InputFilePath = inputFile;
    }

    public InvertedIndexSeq(int keySize) {
        this();
        KeySize = keySize;
    }

    public InvertedIndexSeq(String inputFile, int keySize) {
        InputFilePath = inputFile;
        KeySize = keySize;
    }
    ...
    /* Getters y setters añadidos para ayudar al testing */
    ...
    private void AddKey(String key, long offset){
        Hash.put(key, offset);
        //System.out.println("Afegeix " + key + " a " + offset); //TODO: PER DEBUG, TREURE DESPRES
