 ...
 */
public class InvertedIndex_seq
{
    // Constantes
    ...
    // Constructores
    public InvertedIndex_seq() {
        InputFilePath = null;
        KeySize = DKeySize;
    }

    public InvertedIndex_seq(String inputFile) {
        this();
        InputFilePath = inputFile;
    }

    public InvertedIndex_seq(int keySize) {
        this();
        KeySize = keySize;
    }

    public InvertedIndex_seq(String inputFile, int keySize) {
        InputFilePath = inputFile;
        KeySize = keySize;
    }
